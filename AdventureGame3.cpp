...
cin>>username;
cin.ignore();
cout<<"Welcome "<<username<<" to the AMAZING ADVENTURE GAME YOU WILL EVER SEE";
cin.get();
int plane;
...
cin.get();
cout<<"in the distance you see something comin towards you...IT'S A GIANT CRAWFISH!";
cin.get();
cout<<"It randomly falls into the sand a pops out cooked right into the Motel's pool";
cin.get();
int dinosaur;
cout<<"you see something else coming...but this time its not a crawfish ITS A DINOSAUR"<<endl;
...
int rifle;
cout<<" should you grab the rifle and shoot at the dinosaur or hide in the other room"<<endl<<"1 grab the rifle and shoot it"<<endl<<"2 hide";
cin>>rifle;
cin.get();
